...
t = 0.0084;
catchpole = [0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8; ...
            0.32, 0.49, 0.739, 0.97, 1.05, 1.11, 1.15, 1.2, 1.23];
catchpole = [0.75;1.2];
...
figure()
plot(distL(1,:),distL(2,:))
save('wingCover.mat','upper', 'rib')