function [loads, wing_weight_per_span, fuel_weight_per_span, engine_weight_load, uc_weight_per_span] = WingInertiaLoads(y, n, chord_dist, disc)
...
idx_fuel_span_pos = find(y == round(fuel_tank_span./ds)*ds);
idx_engine_pos = find(y == round(engine_location./ds)*ds);
idx_uc_span_pos = find(y == round(uc_location_span./ds)*ds);
